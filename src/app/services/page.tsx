...
export default function ServicesPage(props: ServicesProps) {
  ...
  return (
    <main className={cx(s('container'), 'page')}>
      ...
      >
        <>
          At <span>Code Breeze</span>, we specialize in delivering comprehensive digital solutions, from web development
          to mobile apps. Our team of experts ensures every project is tailored to meet your business needs, providing a
      ...
      >
        <>
          ...
          <p>
            We offer complete web development services to give your business a fully functional website. From design to
            hosting, we handle all the technical details, so you can focus on running your business. Whether you prefer
            a custom design or a template, we deliver a seamless experience.
          </p>
          <h3>What's Included</h3>
          <p>
            Our services cover everything needed to get your website online, with ongoing support to keep it running
            smoothly.
          </p>
          <ul>
            <li>
              <strong>Custom or Template Design: </strong> Choose between a unique design or a quick, high-quality
              template.
            </li>
            <li>
            ...
            <li>
              <strong>Integration of Features:</strong>From e-commerce to booking systems, we integrate what your
              business needs.
            </li>
            <li>
          ...
          <p>
            Unlike typical one-off website projects, our service goes beyond just development. We continue to manage and
            maintain your website, ensuring it stays updated and functional over time.
          </p>
          <ul>
          ...
          <p>
            We understand that building a website is just the beginning. Our service model ensures that you have a
            reliable partner for the long term. We don’t just build websites; we provide a complete web solution that
      ...
      >
        <>
          <h1>Mobile App</h1>
          <p>
            We develop mobile apps that are scalable, efficient, and tailored to meet your unique business needs. Our
            team handles everything, from design to deployment, ensuring your app runs smoothly across all devices and
            platforms.
          </p>
          <h3>What's Included</h3>
          ...
          <ul>
            <li>
              <strong>Custom or Template Design: </strong> Choose between a tailored design or a fast, template-based
              approach.
            </li>
            <li>
          ...
          <h3>Ongoing Support as a Service</h3>
          <p>
            We don’t just launch your app—we maintain it, ensuring updates and new features are added as your business
            grows.
          </p>
          <ul>
          ...
          <h3>Why Choose Us</h3>
          <p>
            We offer a comprehensive mobile app solution that goes beyond development, ensuring your app continues to
            perform as your business grows.
          </p>
          <li>
      ...
      >
        <>
          ...
          <p>
            Our cloud solutions provide scalable, secure, and efficient infrastructure tailored to your business needs.
            We design and implement cloud systems that grow with your company, ensuring smooth operations and
            flexibility for future expansion.
          </p>
          <h3>What's Included</h3>
          <p>
            Our cloud services cover everything from setup to continuous management, giving you a robust platform
            without the complexity.
          </p>
          <ul>
            <li>
              <strong>Custom Architecture: </strong>We design cloud infrastructures that align with your specific
              business goals.
            </li>
            <li>
              <strong>Seamless Integration: </strong>We integrate cloud services with your existing systems for a smooth
              transition.
            </li>

            <li>
              <strong>Data Security: </strong>Implementing best practices to ensure your data is safe and fully
              compliant.
            </li>
            <li>
          ...
          <h3>Ongoing Support as a Service</h3>
          <p>
            We don’t just set up your cloud infrastructure; we offer continuous support and optimization to ensure it
          ...
          <h3>Why Choose Us</h3>
          <p>
            Our cloud solutions offer a full-service approach, from setup to ongoing support, so your business can
            operate smoothly and grow efficiently.
          </p>
          <li>
          ...
          <li>
            <strong>Client-First Approach: </strong> We work closely with you to ensure our solutions align with your
            business needs.
          </li>
        </>
      </ImageTextFullSection>
